...
const LIFECYCLE = [
  ...
  ["Submit proof references", "Record the source URL and a hash of what you observed."],
  ["Freeze the evidence set", "Locks claims and proofs so adjudication runs on a fixed record."],
  ["GenLayer identity evaluation", "Validators retrieve sources live and reach consensus."],
